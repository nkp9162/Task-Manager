      ...
      >
        ...
        <span >
          <button
            ...
            className=" btn btn-secondary mr-2 "style={{ marginRight: '10px' }}
          >
            Edit
          </button>
          <button
  ...
  render() {
    return (
      <main className="content">
        <h1 className="text-black text-uppercase text-center my-4 bg-info text py-4">Task Manager</h1>
        <div className="row ">
        ...
        <footer className="my-3 mb-2 bg-info text white text-center py-5">Copyright 2024 &copy; All Rights Reserved </footer>
        {this.state.modal ? (
          <Modal
